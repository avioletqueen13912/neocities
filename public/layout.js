...
function footerHTML() {
  ...
  return `
<footer><div>all rights reserved. (idk what that means, it just seems like the thing to say.) | <a href="https://midsummerjay.neocities.org/sitemap">sitemap.</a> | template generated by <a href="https://petrapixel.neocities.org/" target="_blank"><img src="https://cdn.jsdelivr.net/gh/petracoding/petrapixel.neocities.org@latest/public/assets/img/linkback.gif" alt="petrapixel"></a>.</div></footer>`;
}
